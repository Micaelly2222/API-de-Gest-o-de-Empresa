...
class Organization(BaseModel):
    """Modelo de empresas"""
    id: Optional[str] = Field(default_factory=lambda: str(uuid4()), alias='_id', description="Identificador da mensagem") #Optional: não é um campo obrigatorio
    name: str
...
@app.post("/api/v1/organizations", response_model=Organization,  status_code=status.HTTP_200_OK) #rota da API, responsável por realizar o cadastro de novas organizacoes, com a requisição do tipo POST
